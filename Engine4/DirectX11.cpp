...
bool DirectX11::Initialize(int screenWidth, int screenHeight, bool vsync, HWND hwnd, bool fullscreen, float screenDepth, float screenNear)
{
	HRESULT result;
...
void DirectX11::BeginScene(float red, float green, float blue, float alpha)
{
	float color[4];
...
void DirectX11::GetProjectionMatrix(XMMATRIX& projectionMatrix)
{
...
void DirectX11::GetWorldMatrix(XMMATRIX& worldMatrix)
{
...
void DirectX11::GetOrthoMatrix(XMMATRIX& orthoMatrix)
{
